 ...
 * @author Admin
 */
public class IncluirAgente extends javax.swing.JFrame {
    JFrame principal;
    ...
    private void initComponents() {
        ...
        CrearAdmin.setText("Crear Agente");
        ...
        jPanel1.add(TeatroLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 90, 800, -1));
    ...
    private void CrearAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CrearAdminActionPerformed
        ...
        try{
            state = Teatros.InsertAgente(this, teatro, nombre + " " + apellido, cedula, sexo, nacimiento, direccion, telCelular, telCasa, telOtro, correo, user, pass);
        }catch (Exception e){
            JOptionPane.showMessageDialog(this, "Error al añadir el agente", "Advertencia",0);
            return;
        }

        if(!state){
            JOptionPane.showMessageDialog(this, "No se añadió el agente", "Advertencia",0);
            return;
        }

        JOptionPane.showMessageDialog(this, "Agente agregado exitosamente", "Info",1);
        cerrar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IncluirAgente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IncluirAgente(null).setVisible(true);
            }
        });
    }
